        ...
        <div className="bg-gradient-to-r from-violet-950 to-violet-50 p-8 sm:p-4 pt-10 sm:pt-5 w-screen flex flex-row justify-center overflow-hidden">
            <div className="w-5/6 max-w-7xl py-5 px-10 sm:px-3 h-auto mx-auto bg-violet-50 drop-shadow-lg rounded-md border border-pink-400">
                <div className="relative bg-violet-950 py-8 pl-20 -ml-60 sm:-ml-20 mb-10 border-r border-y border-pink-400 rounded-r-md">
                    <h2 className="text-3xl sm:text-xl font-semibold text-violet-50 absolute -mt-3 ml-40 sm:ml-5">Hello! I'm Mary Beth -</h2>
                </div>
                <div className="flex flex-row w-full mx-auto max-w-6xl">
                    <div className="mx-4">
                        <img className="w-1/3 border border-violet-300 drop-shadow-lg rounded-md float-right ml-5" src={headshot} alt='headshot' />
                        <p className="text-lg sm:text-sm text-right leading-relaxed mt-2">
