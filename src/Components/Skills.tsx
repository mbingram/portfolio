        ...
        <div className="bg-gradient-to-r from-violet-950 to-violet-50 p-8 pt-10 w-screen flex flex-row justify-center overflow-hidden">
            <div className="w-5/6 py-5 px-10 mx-auto bg-violet-50 drop-shadow-lg rounded-md border border-pink-400">
                <div className="relative bg-violet-950 py-8 pl-20 -ml-60 mb-5">
                    <h2 className="text-3xl font-semibold text-violet-50 absolute -mt-3 ml-40">Skills</h2>
                </div>
                <p className="mb-6">As a creative and self-motivated individual, I am dedicated to continuous learning and staying up-to-date with the latest advancements in the field.
                ...
                Now, I'm using my knowledge to further explore the possibilities of Smart Contracts, NFTs, and the rest of what Web3 has to offer. </p>
                <div className="flex flex-row w-full">
                    ...
                    <div className="w-4/5">
                        ...
                        <p className="text-gray-600 mb-4">
                            <p className="font-semibold">Full Stack Engineer at ChattyKathi</p>
                        ...
                        <p className="text-gray-600 mb-4">
                            <p className="font-semibold">Mentor for Computer Science student from UVA Darden.</p>
                        ...
                        <p className="text-gray-600 mb-4">
                            <p className="font-semibold">Full Stack Engineer at CLMBR</p>
                        ...
                        <p className="text-gray-600 mb-4">
                            <p className="font-semibold">Flatiron School of Software Engineering (Denver, CO)</p>
